...
public class NodaTimeProfile : Profile
{
    ...
    private void CreateMappingsForDurationConverter()
    {
        ...
        CreateMap<decimal?, Duration?>().ConvertUsing(source => source.HasValue ? Duration.FromTicks((long)( source.Value * NodaConstants.TicksPerMillisecond )) : default(Duration?));
        CreateMap<double, Duration>().ConvertUsing(source => Duration.FromTicks((long)( source * NodaConstants.TicksPerMillisecond )));
        CreateMap<double?, Duration?>().ConvertUsing(source => source.HasValue ? Duration.FromTicks((long)( source.Value * NodaConstants.TicksPerMillisecond )) : default(Duration?));
        ...
        CreateMap<Duration?, decimal?>().ConvertUsing(source => source.HasValue ? (decimal)source.Value.BclCompatibleTicks / NodaConstants.TicksPerMillisecond : default(decimal?));
        CreateMap<Duration?, double?>().ConvertUsing(source => source.HasValue ? (double)source.Value.BclCompatibleTicks / NodaConstants.TicksPerMillisecond : default(double?));
        CreateMap<Duration?, int?>().ConvertUsing(source => source.HasValue ? (int)( source.Value.BclCompatibleTicks / NodaConstants.TicksPerSecond ) : default(int?));
        CreateMap<Duration?, long?>().ConvertUsing(source => source.HasValue ? source.Value.BclCompatibleTicks / NodaConstants.TicksPerMillisecond : default(long?));
        ...
        CreateMap<int?, Duration?>().ConvertUsing(source => source.HasValue ? Duration.FromTicks(source.Value * NodaConstants.TicksPerSecond) : default(Duration?));
        CreateMap<long, Duration>().ConvertUsing(source => Duration.FromTicks(source * NodaConstants.TicksPerMillisecond));
        CreateMap<long?, Duration?>().ConvertUsing(source => source.HasValue ? Duration.FromTicks(source.Value * NodaConstants.TicksPerMillisecond) : default(Duration?));
    ...
    private void CreateMappingsForLocalTimeConverter()
    {
        ...
        CreateMap<LocalTime?, DateTime?>().ConvertUsing(source => source.HasValue ? source.Value.On(new LocalDate(1, 1, 1)).ToDateTimeUnspecified() : default(DateTime?));
    ...
    private void CreateMappingsForOffsetDateTimeConverter()
    {
        ...
        CreateMap<DateTimeOffset?, OffsetDateTime?>().ConvertUsing(source => source.HasValue ? OffsetDateTime.FromDateTimeOffset(source.Value) : default(OffsetDateTime?));
